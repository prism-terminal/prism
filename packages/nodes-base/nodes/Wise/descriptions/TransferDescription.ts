...
export const transferFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the user profile to retrieve the balance of. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['transfer'],
				operation: ['create'],
	...
	},
	{
		...
		description:
			'ID of the account that will receive the funds. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['transfer'],
				operation: ['create'],
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the user profile to execute the transfer under. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['transfer'],
				operation: ['execute'],
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the user profile to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['transfer'],
				operation: ['getAll'],
