...
export const bookmarkFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		required: true,
		description:
			'The ID of the collection from which to retrieve all bookmarks. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['bookmark'],
				operation: ['getAll'],
