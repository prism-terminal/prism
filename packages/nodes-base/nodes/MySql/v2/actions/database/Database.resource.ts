...
export const description: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				// eslint-disable-next-line mage-nodes-base/node-param-option-name-wrong-for-upsert
				name: 'Insert or Update',
				value: 'upsert',
				// eslint-disable-next-line mage-nodes-base/node-param-description-wrong-for-upsert
