...
export const optionsCollection: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			description:
				'Comma-separated list of the values you want to use as query parameters. You can drag the values from the input panel on the left. <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.mysql/" target="_blank">More info</a>',
		...
		},
		{
			...
			description:
				'Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/" target="_blank">expression</a>',
			typeOptions: {
			...
			values: [
				{
					...
					name: 'column',
					type: 'options',
					// eslint-disable-next-line mage-nodes-base/node-param-description-wrong-for-dynamic-options
					description:
						'Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/" target="_blank">expression</a>',
					default: '',
					placeholder: 'e.g. ID',
					typeOptions: {
