	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				default: '',
				description:
					'ID of list to operate on. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Email',
				name: 'email',
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						default: [],
						description:
							'List of tag IDs to be added. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
					},
				],
			},
			//--------------------
