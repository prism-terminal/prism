	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			/* -------------------------------------------------------------------------- */
			{
				...
				required: true,
				description:
					'List of lists. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Email',
				name: 'email',
						...
						values: [
							{
								...
								required: true,
								description:
									'Merge Field name. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
								default: '',
							},
							{
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						default: [],
						description:
							'A comma-separated list of fields to exclude. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
					},
					{
						...
						description:
							'A comma-separated list of fields to return. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
					},
					{
						displayName: 'List Name or ID',
						name: 'listId',
