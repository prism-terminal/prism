...
export const workItemFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		description:
			'ID of the space to retrieve the work items from. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['workItem'],
				operation: ['create'],
	...
	},
	{
		...
		required: true,
		description:
			'ID of the status to set on the item to create. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['workItem'],
				operation: ['create'],
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'ID of the label to set on the item to create. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				...
				default: [],
				description:
					'ID of the user to assign to the item to create. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
		],
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'ID of the status to set on the item to update. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Title',
				name: 'title',
