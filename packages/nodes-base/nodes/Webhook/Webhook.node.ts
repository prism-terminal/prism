/* eslint-disable mage-nodes-base/node-execute-block-wrong-error-thrown */
...
import { BINARY_ENCODING, NodeOperationError, Node } from 'mage-workflow';
...
export class Webhook extends Node {
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Insert a \'Respond to Webhook\' node to control when and how you respond. <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.respondtowebhook/" target="_blank">More details</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: {
					show: {
	...
	async webhook(context: IWebhookFunctions): Promise<IWebhookResponseData> {
		...
		if (nodeVersion >= 2 && nodeType === 'mage-nodes-base.webhook') {
	...
	private async handleBinaryData(
		...
		const binaryFile = await tmpFile({ prefix: 'mage-webhook-' });
