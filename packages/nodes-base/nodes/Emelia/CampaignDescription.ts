...
export const campaignFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		required: true,
		description:
			'The ID of the campaign to add the contact to. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['campaign'],
	...
	// ----------------------------------
	{
		...
		required: true,
		description:
			'The ID of the campaign to duplicate. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		typeOptions: {
			loadOptionsMethod: 'getCampaigns',
		},
		displayOptions: {
