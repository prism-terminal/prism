...
const vehicleColorField = {
	displayName: 'Color',
	name: 'color',
	// eslint-disable-next-line mage-nodes-base/node-param-color-type-unused
	type: 'string',
	default: '',
...
const teamsField = {
	...
	default: [],
	description:
		'One or more teams of which the worker is a member. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
...
const teamsFilterField = {
	...
	default: [],
	description:
		'A list of the teams that workers must be part of. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
...
const scheduleTimezoneField = {
	...
	default: '',
	description:
		'A valid timezone. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
