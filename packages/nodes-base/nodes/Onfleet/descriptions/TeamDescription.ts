...
const workersField = {
	...
	default: [],
	description:
		'A list of workers. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
...
const managersField = {
	...
	default: [],
	description:
		'A list of managing administrators. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
...
const hubField = {
	...
	default: '',
	description:
		'The team\'s hub. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
} as INodeProperties;
