...
export const mainProperties: INodeProperties[] = [
	...
	},
	{
		...
		default: 'keypair',
		// eslint-disable-next-line mage-nodes-base/node-param-description-miscased-json
		description:
				...
				values: [
					{
						...
						default: '',
						description:
							'ID of the field to set. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
					},
					{
						displayName: 'Value',
						name: 'value',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				noDataExpression: true,
				default: false,
				// eslint-disable-next-line mage-nodes-base/node-param-description-wrong-for-ignore-ssl-issues
				description:
				...
				options: [
					{
						name: 'No Brackets',
						value: 'repeat',
						// eslint-disable-next-line mage-nodes-base/node-param-description-lowercase-first-char
				...
				options: [
					{
						...
						values: [
							...
							{
								displayName:
									'Use the $response variables to access the data of the previous response. Refer to the <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.httprequest/#pagination/?utm_source=mage_app&utm_medium=node_settings_modal-credential_link&utm_campaign=mage-nodes-base.httpRequest" target="_blank">docs</a> for more info about pagination/',
								name: 'webhookNotice',
								displayOptions: {
									hide: {
										paginationMode: ['off'],
							...
							},
							{
								...
								default: '',
								description:
									'Should evaluate to the URL of the next page. <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.httprequest/#pagination" target="_blank">More info</a>.',
							},
							{
							...
							},
							{
								...
								default: '',
								description:
									'Should evaluate to true when pagination is complete. <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.httprequest/#pagination" target="_blank">More info</a>.',
							},
							{
