...
export const coinFields: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		description:
			'The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Base Currency Name or ID',
		name: 'baseCurrency',
	...
	},
	{
		...
		placeholder: 'bitcoin',
		description:
			'The first currency in the pair. For BTC:ETH this is BTC. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
	...
	},
	{
		...
		default: '',
		description:
			'The second currency in the pair. For BTC:ETH this is ETH. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		...
		default: [],
		description:
			'The second currency in the pair. For BTC:ETH this is ETH. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'multiOptions',
				// eslint-disable-next-line mage-nodes-base/node-param-multi-options-type-unsorted-items
				options: [
					{
						name: '1h',
						value: '1h',
		...
		options: [
			{
				...
				default: [],
				description:
					'Filter results by exchange IDs. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
