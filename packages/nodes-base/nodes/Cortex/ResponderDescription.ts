...
export const responderFields: INodeProperties[] = [
	{
		...
		description:
			'Choose the responder. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		...
		default: '',
		description:
			'Choose the Data type. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
