...
export const messageConversationFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		required: true,
		description:
			'The ID of the workspace. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		...
		required: true,
		description:
			'The ID of the conversation. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Content',
		name: 'content',
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'The users that are directly mentioned. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			// {
