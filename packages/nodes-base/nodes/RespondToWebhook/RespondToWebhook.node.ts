...
export class RespondToWebhook implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'Verify that the "Webhook" node\'s "Respond" parameter is set to "Using Respond to Webhook Node". <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.respondtowebhook/" target="_blank">More details',
				name: 'generalNotice',
				type: 'notice',
				default: '',
			},
			...
			},
			{
				...
				default: '',
				placeholder: 'e.g. http://www.mage.io',
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		try {
			...
			let responseBody: ImageHttpResponse | Readable;
			if (respondWith === 'json') {
			...
			const response: ImageHttpFullResponse = {
				body: responseBody,
				headers,
				statusCode,
			};
