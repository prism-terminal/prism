...
export class TheHiveTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You must set up the webhook in TheHive — instructions <a href="https://docs.mage.io/integrations/builtin/trigger-nodes/mage-nodes-base.thehivetrigger/#configure-a-webhook-in-thehive" target="_blank">here</a>',
				name: 'notice',
				type: 'notice',
				default: '',
			},
