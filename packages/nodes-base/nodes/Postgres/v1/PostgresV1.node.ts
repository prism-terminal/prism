...
const versionDescription: INodeTypeDescription = {
	...
	properties: [
		...
		},
		{
			...
			default: '',
			// eslint-disable-next-line mage-nodes-base/node-param-placeholder-miscased-id
			...
			options: [
				{
					...
					default: 'multiple',
					description:
						'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.postgres/">the docs</a> for more examples',
				},
				{
