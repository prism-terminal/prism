...
export const optionsCollection: INodeProperties = {
	...
	options: [
		...
		},
		{
			...
			default: '',
			description:
				'Comma-separated list of the values you want to use as query parameters. <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.postgres/#use-query-parameters" target="_blank">More info</a>.',
