...
export const organizationDescription: INodeProperties[] = [
	...
	},
	{
		...
		type: 'string',
		description:
			'Organization to update. Specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'string',
		description:
			'Organization to delete. Specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'string',
		description:
			'Organization to retrieve. Specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		default: '',
		required: true,
		displayOptions: {
			show: {
