import type { IDataObject, ILoadOptionsFunctions, INodePropertyOptions } from 'mage-workflow';
...
export async function getColumnsWithRecordId(
	...
	return [
		{
			// eslint-disable-next-line mage-nodes-base/node-param-display-name-miscased-id, mage-nodes-base/node-param-display-name-miscased
			name: 'id',
			value: 'id' as string,
