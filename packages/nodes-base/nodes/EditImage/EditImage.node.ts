...
import { NodeOperationError, NodeConnectionType, deepCopy } from 'mage-workflow';
				...
				options: [
					{
						...
						values: [
							...
							...nodeOperationOptions,
							{
								...
								default: '',
								description:
									'The font to use. Defaults to Arial. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
							},
						],
					},
				],
