...
export const salesActivityFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		description:
			'ID of a sales activity type for which the sales activity is created. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['salesActivity'],
				operation: ['create'],
	...
	},
	{
		...
		name: 'ownerId',
		description:
			'ID of the user who owns the sales activity. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		type: 'options',
		default: '',
		typeOptions: {
		...
		options: [
			{
				...
				description:
					'ID of the user who created the sales activity. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				description:
					'ID of a sales activity\'s outcome. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
		],
	},
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'ID of a sales activity type for which the sales activity is updated. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Start Date',
				name: 'from_date',
