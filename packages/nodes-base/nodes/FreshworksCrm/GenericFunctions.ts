...
// /**
//  * Adjust attendee data from mage UI to the format expected by Freshworks CRM API.
//  */
...
/**
 * Adjust account data from mage UI to the format expected by Freshworks CRM API.
 */
