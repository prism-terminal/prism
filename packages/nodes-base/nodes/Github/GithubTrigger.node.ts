			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/mage-io',
						extractValue: {
							type: 'regex',
			...
			},
			{
				...
				modes: [
					...
					},
					{
						...
						name: 'url',
						type: 'string',
						placeholder: 'e.g. https://github.com/mage-io/mage',
						extractValue: {
							type: 'regex',
				...
				options: [
					{
						...
						default: false,
						description:
							'Whether the SSL certificate of the mage host be verified by GitHub when delivering payloads',
					},
				],
			},
		],
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (webhookUrl.includes('//localhost')) {
					throw new NodeOperationError(
						this.getNode(),
						'The Webhook can not work on "localhost". Please, either setup mage on a custom domain or start with "--tunnel"!',
					);
				}
