...
export const messageFields: INodeProperties[] = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		required: true,
		description:
			'The channel to send the message to. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Text',
		name: 'text',
	...
	/* ----------------------------------------------------------------------- */
	{
		...
		description:
			'The token to start returning events from. This token can be obtained from a prev_batch token returned for each room by the sync API. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		required: true,
	},
	{
