...
import { NodeOperationError, NodeConnectionType, WAIT_INDEFINITELY } from 'mage-workflow';
...
export class Wait extends Webhook {
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'The webhook URL will be generated at run time. It can be referenced with the <strong>$execution.resumeUrl</strong> variable. Send it somewhere before getting to this node. <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.wait/?utm_source=mage_app&utm_medium=node_settings_modal-credential_link&utm_campaign=mage-nodes-base.wait" target="_blank">More info</a>',
				name: 'webhookNotice',
				type: 'notice',
				displayOptions: displayOnWebhook,
				default: '',
