		...
		options: [
			{
				...
				default: [],
				description:
					'The Call properties to include in the returned results. Choose from a list, or specify IDs using an <a href="https://docs.mage.io/code-examples/expressions/">expression</a>.',
				options: [
					{
						name: 'Action Items',
					...
					output: {
						postReceive: [
							async function (
								...
								_responseData: ImageHttpFullResponse,
			...
			output: {
				postReceive: [
					async function (
						this: IExecuteSingleFunctions,
						items: INodeExecutionData[],
						_response: ImageHttpFullResponse,
					): Promise<INodeExecutionData[]> {
