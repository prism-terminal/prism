import type { IDataObject, IExecuteFunctions, INodeProperties } from 'mage-workflow';
		...
		options: [
			{
				...
				default: [],
				description:
					'If set, the calendar will be created in the specified calendar group. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Color',
				name: 'color',
