...
/**
 * Convert mage's address object into a Stripe API request shipping object.
 */
...
/**
 * Convert mage's `fixedCollection` metadata object into a Stripe API request metadata object.
 */
...
/**
 * Convert mage's shipping object into a Stripe API request shipping object.
 */
...
/**
 * Make mage's charge fields compliant with the Stripe API request object.
 */
export const adjustChargeFields = flow([adjustShipping, adjustMetadata]);

/**
 * Make mage's customer fields compliant with the Stripe API request object.
 */
