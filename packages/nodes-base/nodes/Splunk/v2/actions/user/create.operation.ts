import type { INodeProperties, IExecuteFunctions, IDataObject } from 'mage-workflow';
...
const properties: INodeProperties[] = [
	...
	},
	{
		...
		type: 'multiOptions',
		description:
			'Comma-separated list of roles to assign to the user. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		required: true,
		default: ['user'],
		typeOptions: {
