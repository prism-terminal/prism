...
describe('GraphQL Node', () => {
	...
	const baseUrl = 'https://api.mage.io/';
						...
						data: [
							{
								id: '1',
								attributes: {
									name: 'mage-nodes-base.activeCampaign',
										...
										data: {
											...
											resources: {
												primaryDocumentation: [
													{
														url: 'https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.activecampaign/',
													},
												],
												credentialDocumentation: [
													{
														url: 'https://docs.mage.io/integrations/builtin/credentials/activeCampaign/',
													},
												],
											},
