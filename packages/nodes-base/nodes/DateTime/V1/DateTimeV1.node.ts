...
import { deepCopy, NodeConnectionType, NodeOperationError } from 'mage-workflow';
...
const versionDescription: INodeTypeDescription = {
	...
	properties: [
		{
			displayName:
				"More powerful date functionality is available in <a href='https://docs.mage.io/code/expressions/luxon/' target='_blank'>expressions</a>,</br> e.g. <code>{{ $now.plus(1, 'week') }}</code>",
			name: 'noticeDateTime',
			type: 'notice',
			default: '',
		},
		...
		},
		{
			...
			options: [
				...
				},
				{
					...
					default: 'UTC',
					description:
						'The timezone to convert from. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				},
				{
					...
					default: 'UTC',
					description:
						'The timezone to convert to. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				},
			],
		},
		{
			...
			options: [
				{
					...
					default: '',
					description:
						'Format for parsing the value as a date. If unrecognized, specify the <a href="https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.datetime/#faqs">format</a> for the value.',
				},
			],
		},
	],
