...
export const purchaseOrderFields: INodeProperties[] = [
	...
	// ----------------------------------------
	{
		...
		description:
			'ID of the vendor associated with the purchase order. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['purchaseOrder'],
	...
	},
	{
		...
		options: [
			...
			shippingAddress,
			{
				...
				description:
					'Status of the purchase order. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
