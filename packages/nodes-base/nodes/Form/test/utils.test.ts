...
describe('FormTrigger, formWebhook', () => {
	...
	it('should call response render', async () => {
		...
		expect(mockRender).toHaveBeenCalledWith('form-trigger', {
			...
			formTitle: 'Test Form',
			mageWebsiteLink:
				'https://mage.io/?utm_source=mage-internal&utm_medium=form-trigger&utm_campaign=instanceId',
			testRun: true,
...
describe('FormTrigger, prepareFormData', () => {
	it('should return valid form data with given parameters', () => {
		...
		expect(result).toEqual({
			...
			formSubmittedText: 'Thank you for your submission',
			mageWebsiteLink:
				'https://mage.io/?utm_source=mage-internal&utm_medium=form-trigger&utm_campaign=test-instance',
			formFields: [
				{
					id: 'field-0',
					errorId: 'error-field-0',
	...
	it('should handle missing optional fields gracefully', () => {
		...
		expect(result).toEqual({
			...
			formDescription: 'This is a test form',
			formSubmittedText: 'Your response has been recorded',
			mageWebsiteLink: 'https://mage.io/?utm_source=mage-internal&utm_medium=form-trigger',
			formFields: [
				{
					id: 'field-0',
					errorId: 'error-field-0',
...
describe('prepareFormReturnItem', () => {
	...
	const formNode = mock<INode>({ type: 'mage-nodes-base.formTrigger' });
