...
export const formFieldsProperties: INodeProperties[] = [
	...
	},
	{
		...
		hint: '<a href="hhttps://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.form/" target="_blank">See docs</a> for field syntax',
		displayOptions: {
			show: {
				defineForm: ['json'],
			},
	...
	[
		{
			...
			displayName: 'On mage Form Submission',
			name: 'respondWith',
			type: 'options',
			default: 'text',
			options: [
...
export class Form extends Node {
	...
	description: INodeTypeDescription = {
		...
		properties: [
			{
				// eslint-disable-next-line mage-nodes-base/node-param-display-name-miscased
				displayName: 'An mage Form Trigger node must be set up before this node',
				name: 'triggerNotice',
				type: 'notice',
				default: '',
			},
	...
	async webhook(context: IWebhookFunctions) {
		...
		const trigger = parentNodes.find(
			(node) => node.type === 'mage-nodes-base.formTrigger',
