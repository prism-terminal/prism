	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'List of categories. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
			...
			},
			{
				...
				default: [],
				description:
					'List of tags. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'Limit result set to products assigned a specific category ID. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Context',
				name: 'context',
			...
			},
			{
				...
				description:
					'Limit result set to products assigned a specific tag ID. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Tax Class',
				name: 'taxClass',
