...
export const sessionFields: INodeProperties[] = [
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: {},
				description:
					'Webinar by which to filter the sessions to retrieve. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
		],
	},
	...
	// ----------------------------------
	{
		...
		default: [],
		description:
			'Key of the webinar to which the session belongs. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['session'],
