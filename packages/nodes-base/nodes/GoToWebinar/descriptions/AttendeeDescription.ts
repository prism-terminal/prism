...
export const attendeeFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		default: '',
		description:
			'Key of the webinar that the attendee attended. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['attendee'],
			},
	...
	},
	{
		...
		default: '',
		description:
			'Key of the session that the attendee attended. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['attendee'],
			},
