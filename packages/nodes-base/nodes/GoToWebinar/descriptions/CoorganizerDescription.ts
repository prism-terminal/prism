...
export const coorganizerFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		default: [],
		description:
			'Key of the webinar that the co-organizer is hosting. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['coorganizer'],
				operation: ['create'],
	...
	// ----------------------------------
	{
		...
		default: [],
		description:
			'Key of the webinar to delete. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['coorganizer'],
				operation: ['delete'],
	...
	// ----------------------------------
	{
		...
		default: [],
		description:
			'Key of the webinar to retrieve all co-organizers from. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['coorganizer'],
				operation: ['getAll'],
