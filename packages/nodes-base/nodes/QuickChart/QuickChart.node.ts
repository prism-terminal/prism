...
import { jsonParse, NodeConnectionType, NodeOperationError } from 'mage-workflow';
...
export class QuickChart implements INodeType {
	...
	async execute(this: IExecuteFunctions): Promise<INodeExecutionData[][]> {
		...
		const response = (await this.helpers.httpRequest(options)) as ImageHttpFullResponse;
