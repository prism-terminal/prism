...
export const sendMessageResponse = {
	...
	result: {
		...
		date: 1732960606,
		text: 'a\n\nThis message was sent automatically with mage',
		entities: [
			{
				offset: 3,
				length: 41,
			...
			},
			{
				...
				length: 3,
				type: 'text_link',
				url: 'https://mage.io/?utm_source=mage-internal&utm_medium=powered_by&utm_campaign=mage-nodes-base.telegram_8c8c5237b8e37b006a7adce87f4369350c58e41f3ca9de16196d3197f69eabcd',
			},
		],
