...
describe('Telegram > GenericFunctions', () => {
	...
	describe('addAdditionalFields', () => {
		...
		it('should add additional fields and attribution for sendMessage operation', () => {
			...
			expect(body).toEqual({
				text: 'Hello, world!\n\n_This message was sent automatically with _[mage](https://mage.io/?utm_source=mage-internal&utm_medium=powered_by&utm_campaign=mage-nodes-base.telegram_45)',
				parse_mode: 'Markdown',
		...
		it('should handle nodeVersion 1.2 and set disable_web_page_preview', () => {
			...
			expect(body).toEqual({
				disable_web_page_preview: true,
				parse_mode: 'Markdown',
				text: 'Hello, world!\n\n_This message was sent automatically with _[mage](https://mage.io/?utm_source=mage-internal&utm_medium=powered_by&utm_campaign=mage-nodes-base.telegram)',
			});
		});
	});
