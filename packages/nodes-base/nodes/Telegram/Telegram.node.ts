...
import { BINARY_ENCODING, NodeConnectionType, NodeOperationError } from 'mage-workflow';
				...
				options: [
					{
						...
						description:
							'Whether to include the phrase “This message was sent automatically with mage” to the end of the message',
						displayOptions: {
							show: {
