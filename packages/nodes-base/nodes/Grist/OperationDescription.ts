...
export const operationFields: INodeProperties[] = [
	{
		...
		options: [
			...
			{
				// eslint-disable-next-line mage-nodes-base/node-param-option-name-wrong-for-get-many
				name: 'Get Many Rows',
				value: 'getAll',
						...
						values: [
							{
								...
								default: '',
								description:
									'Column to apply the filter in. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
								required: true,
							},
							{
								displayName: 'Values',
						...
						values: [
							{
								...
								required: true,
								description:
									'Column to sort on. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
							},
							{
