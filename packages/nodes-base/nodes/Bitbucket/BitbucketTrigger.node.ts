	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				default: '',
				description:
					'The repository of which to listen to the events. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				...
				default: [],
				description:
					'The events to listen to. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
