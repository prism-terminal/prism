...
export const leadFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the campaign to create the lead under. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['lead'],
				operation: ['create'],
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the campaign to remove the lead from. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['lead'],
				operation: ['delete'],
	...
	// ----------------------------------
	{
		...
		description:
			'ID of the campaign to unsubscribe the lead from. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				resource: ['lead'],
