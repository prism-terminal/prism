	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				// eslint-disable-next-line mage-nodes-base/node-param-description-miscased-id
				description:
			...
			},
			{
				...
				default: [],
				description:
					'The array of tags applied to this task. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
