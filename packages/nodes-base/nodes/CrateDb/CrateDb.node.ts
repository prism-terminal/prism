				...
				options: [
					{
						...
						default: 'multiple',
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.cratedb/">the docs</a> for more examples.',
					},
					{
		...
		if (operation === 'executeQuery') {
			...
			if (mode === 'independently') {
				...
				const where =
					' WHERE ' +
					updateKeys
						// eslint-disable-next-line mage-local-rules/no-interpolation-in-regular-string
