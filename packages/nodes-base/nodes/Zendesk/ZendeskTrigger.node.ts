				...
				options: [
					{
						...
						name: 'fields',
						description:
							'The fields to return the values of. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
						type: 'multiOptions',
						default: [],
						typeOptions: {
			...
			async create(this: IHookFunctions): Promise<boolean> {
				...
				if (service === 'support') {
					...
					const bodyTrigger: IDataObject = {
						trigger: {
							title: `mage-webhook:${urlParts.pathname}`,
							conditions: {
								all: resultAll,
								any: resultAny,
							},
