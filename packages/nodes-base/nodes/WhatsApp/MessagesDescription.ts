...
export const messageTypeFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		description: 'Use a link, an ID, or mage to upload an audio file',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or mage to upload a document',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
			...
			},
			{
				...
				name: 'mage',
				value: 'useMediamage',
				description: 'Upload a binary file on the item being processed in mage',
			},
		],
		displayOptions: {
			show: {
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or mage to upload an image',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
	...
	},
	{
		...
		type: 'options',
		default: 'useMediaLink',
		description: 'Use a link, an ID, or mage to upload a video',
		options: [
			{
				name: 'Link',
				value: 'useMediaLink',
