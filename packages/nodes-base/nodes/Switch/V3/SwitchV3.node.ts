...
import { ApplicationError, NodeConnectionType, NodeOperationError } from 'mage-workflow';
		...
		this.description = {
			...
			properties: [
				...
				},
				{
					...
					// eslint-disable-next-line mage-nodes-base/node-param-default-wrong-for-number
					default: '={{}}',
					description:
