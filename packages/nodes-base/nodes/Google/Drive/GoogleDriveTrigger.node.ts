...
import { NodeConnectionType, NodeApiError } from 'mage-workflow';
	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			},
			{
				...
				required: true,
				description:
					'The drive to monitor. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Watch For',
				name: 'event',
