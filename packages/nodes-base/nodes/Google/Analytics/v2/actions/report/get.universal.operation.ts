...
const dimensionDropdown: INodeProperties[] = [
	...
	},
	{
		...
		default: 'ga:date',
		description:
			'Name of the dimension to fetch, for example ga:browser. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		displayOptions: {
			show: {
				listName: ['other'],
			},
...
export const description: INodeProperties[] = [
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						description:
							'The name of the metric. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
						displayOptions: {
							show: {
								listName: ['other'],
							},
	...
	{
		// eslint-disable-next-line mage-nodes-base/node-param-display-name-wrong-for-simplify
