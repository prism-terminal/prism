...
import { NodeApiError, NodeConnectionType, NodeOperationError } from 'mage-workflow';
		...
		properties: [
			{
				...
				description:
					'As displayed in firebase console URL. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				required: true,
			},
			{
