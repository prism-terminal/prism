import { SEND_AND_WAIT_OPERATION, type INodeProperties } from 'mage-workflow';
	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: [],
				description:
					'Only return messages with labels that match all of the specified label IDs. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Search',
				name: 'q',
