import type { IExecuteFunctions, IDataObject, INodeExecutionData } from 'mage-workflow';
...
export const description: SheetProperties = [
	...
	{
		// eslint-disable-next-line mage-nodes-base/node-param-display-name-miscased, mage-nodes-base/node-param-display-name-wrong-for-dynamic-options
