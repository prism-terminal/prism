...
export class SlackTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Set up a webhook in your Slack app to enable this node. <a href="https://docs.mage.io/integrations/builtin/trigger-nodes/mage-nodes-base.slacktrigger/#configure-a-webhook-in-slack" target="_blank">More info</a>',
				name: 'notice',
				type: 'notice',
				default: '',
			},
			...
			},
			{
				...
				options: [
					...
					},
					{
						...
						default: [],
						description:
							'A comma-separated string of encoded user IDs. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
					},
				],
			},
		],
