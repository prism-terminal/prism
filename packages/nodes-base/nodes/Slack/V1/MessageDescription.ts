...
export const messageFields: INodeProperties[] = [
	...
	/* ----------------------------------------------------------------------- */
	{
		...
		description:
			'Channel containing the message. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
	...
	/* ----------------------------------------------------------------------- */
	{
		...
		description:
			'Channel containing the message to be updated. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Text',
		name: 'text',
	...
	/* ----------------------------------------------------------------------- */
	{
		...
		description:
			'Channel containing the message to be deleted. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Timestamp',
		name: 'timestamp',
