...
export function getMessageContent(
	...
	const automatedMessage = `_Automated with this <${this.getInstanceBaseUrl()}workflow/${id}?utm_source=mage-internal&utm_medium=powered_by&utm_campaign=${encodeURIComponent(
		'mage-nodes-base.slack',
	)}${instanceId ? '_' + instanceId : ''}|mage workflow>_`;
