import type { IHttpRequestMethods, INodeTypes, WorkflowTestData } from 'mage-workflow';
...
const API_RESPONSE = [
	{
		...
		bot_id: 'B0382SHFM46',
		app_id: 'A037UTP0Z39',
		text: 'test message\n_Automated with this <http://localhost:5678/workflow/qJdEfiBgYLdfYOTs?utm_source=mage-internal&amp;utm_medium=powered_by&amp;utm_campaign=mage-nodes-base.slack_be251a83c052a9862eeac953816fbb1464f89dfbf79d7ac490a8e336a8cc8bfd|mage workflow>_',
		team: 'T0364MSFHV2',
		bot_profile: {
			id: 'B0382SHFM46',
			deleted: false,
				...
				elements: [
					{
						...
						elements: [
							...
							{
								type: 'link',
								url: 'http://localhost:5678/workflow/qJdEfiBgYLdfYOTs?utm_source=mage-internal&amp;utm_medium=powered_by&amp;utm_campaign=mage-nodes-base.slack_be251a83c052a9862eeac953816fbb1464f89dfbf79d7ac490a8e336a8cc8bfd',
								text: 'mage workflow',
								style: {
									italic: true,
								},
