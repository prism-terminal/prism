...
export class ErrorTrigger implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'This node will trigger when there is an error in another workflow, as long as that workflow is set up to do so. <a href="https://docs.mage.io/integrations/core-nodes/mage-nodes-base.errortrigger" target="_blank">More info<a>',
				name: 'notice',
				type: 'notice',
				default: '',
			},
