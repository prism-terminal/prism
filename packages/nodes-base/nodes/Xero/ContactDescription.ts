	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				default: '',
				description:
					'The default purchases account code for contacts. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				...
				default: '',
				description:
					'The default sales account code for contacts. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
				displayName: 'Skype',
				name: 'skypeUserName',
