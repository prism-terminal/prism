...
export const boardFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'The user ID in Wekan. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
	...
	// ----------------------------------
	{
		...
		description:
			'The ID of the user that boards are attached. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
