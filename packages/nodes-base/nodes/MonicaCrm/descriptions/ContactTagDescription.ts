...
export const contactTagFields: INodeProperties[] = [
	...
	},
	{
		...
		name: 'tagsToAdd',
		description:
			'Tags to add to the contact. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		type: 'multiOptions',
		typeOptions: {
	...
	},
	{
		...
		name: 'tagsToRemove',
		description:
			'Tags to remove from the contact. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		type: 'multiOptions',
		required: true,
		typeOptions: {
