...
export class ExecutionData implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					"Save important data using this node. It will be displayed on each execution for easy reference and you can filter by it.<br />Filtering is available on Pro and Enterprise plans. <a href='https://mage.io/pricing/' target='_blank'>More Info</a>",
				name: 'notice',
				type: 'notice',
				default: '',
			},
