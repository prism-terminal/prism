...
export const ldapFields: INodeProperties[] = [
	...
	// ----------------------------------
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. ou=users,dc=mage,dc=io',
		required: true,
		typeOptions: {
	...
	},
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. cn=john,ou=users,dc=mage,dc=io',
		required: true,
		typeOptions: {
			alwaysOpenEditWindow: false,
		},
	...
	// ----------------------------------
	{
		...
		type: 'string',
		default: '',
		placeholder: 'e.g. cn=nathan,ou=users,dc=mage,dc=io',
		required: true,
		displayOptions: {
			show: {
				operation: ['rename'],
		...
		options: [
			{
				...
				default: [],
				description:
					'Comma-separated list of attributes to return. Choose from the list, or specify IDs using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
			},
			{
