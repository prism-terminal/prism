...
import { NodeConnectionType, deepCopy } from 'mage-workflow';
...
export class SplitInBatchesV1 implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			{
				displayName:
					'You may not need this node — mage nodes automatically run once for each input item. <a href="https://docs.mage.io/getting-started/key-concepts/looping.html#using-loops-in-mage" target="_blank">More info</a>',
