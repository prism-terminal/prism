	...
	description: INodeTypeDescription = {
		...
		properties: [
			...
			// ----------------------------------
			{
				...
				required: true,
				description:
					'The SQL query to execute. You can use mage expressions or $1 and $2 in conjunction with query parameters.',
			},
				...
				options: [
					{
						...
						default: 'multiple',
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.timescaledb/">the docs</a> for more examples',
					},
					{
