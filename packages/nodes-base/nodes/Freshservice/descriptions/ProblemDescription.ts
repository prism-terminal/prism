...
export const problemFields: INodeProperties[] = [
	...
	},
	{
		...
		name: 'requesterId',
		description:
			'ID of the initiator of the problem. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
		type: 'options',
		required: true,
		default: '',
		typeOptions: {
		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the agent to whom the problem is assigned. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
			...
			},
			{
				...
				default: '',
				description:
					'ID of the department initiating the problem. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
			...
			},
			{
				...
				default: '',
				description:
					'ID of the agent group to which the problem is assigned. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
