		...
		options: [
			{
				...
				default: '',
				description:
					'ID of the agent by whom the asset is managed. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
			...
			},
			{
				...
				default: '',
				description:
					'ID of the asset type to filter by. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
					loadOptionsMethod: 'getAssetTypes',
				},
			},
			{
				...
				default: '',
				description:
					'ID of the department to which the asset belongs. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
			...
			},
			{
				...
				default: '',
				description:
					'ID of the location to filter by. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
				typeOptions: {
