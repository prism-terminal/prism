import type { IDisplayOptions, INodeProperties } from 'mage-workflow';
...
const typeMention: INodeProperties[] = [
	...
	},
	{
		...
		default: '',
		description:
			'The ID of the user being mentioned. Choose from the list, or specify an ID using an <a href="https://docs.mage.io/code/expressions/">expression</a>.',
	},
	{
		displayName: 'Page ID',
		name: 'page',
