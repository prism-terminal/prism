				...
				options: [
					{
						...
						description:
							'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.mage.io/integrations/builtin/app-nodes/mage-nodes-base.questdb/">the docs</a> for more examples.',
					},
					{
