import { ApplicationError, type IExecuteFunctions, type INodeExecutionData } from 'mage-workflow';
...
const envAccessBlocked = process.env.mage_BLOCK_ENV_ACCESS_IN_NODE === 'true';
