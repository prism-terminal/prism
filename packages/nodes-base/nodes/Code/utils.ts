import type { INodeExecutionData, IDataObject } from 'mage-workflow';
import { NodeExecutionOutput } from 'mage-workflow';
	...
	if (
		...
		return new NodeExecutionOutput(
			...
			[
				{
					message:
						'To make sure expressions after this node work, return the input items that produced each output item. <a target="_blank" href="https://docs.mage.io/data/data-mapping/data-item-linking/item-linking-code-node/">More info</a>',
					location: 'outputPane',
				},
			],
		);
