import type { INodeProperties, INodePropertyOptions } from 'mage-workflow';
...
export const looseTypeValidationProperty: INodeProperties = {
	...
	description:
		'If the type of an expression doesn\'t match the type of the comparison, mage will try to cast the expression to the required type. E.g. for booleans <code>"false"</code> or <code>0</code> will be cast to <code>false</code>',
...
export const appendAttributionOption: INodeProperties = {
	displayName: 'Append mage Attribution',
