...
import type { IBinaryData, IDataObject, IExecuteFunctions, INodeExecutionData } from 'mage-workflow';
import { NodeOperationError, BINARY_ENCODING } from 'mage-workflow';
