...
export const ACTION_RECORDED_PAGE = `
	...
	<head>
		...
		<link rel='icon' type='image/png' href='https://mage.io/favicon.ico' />
		<link
		...
		<style>
			*, ::after, ::before { box-sizing: border-box; margin: 0; padding: 0; } body { font-family:
			...
			16px 0px #634DFF0F; margin-bottom: 16px; } .mage-link a { color: #7E8186; font-weight: 600;
			font-size: 12px; text-decoration: none; } .mage-link svg { display: inline-block;
	...
	<body>
		<div class='container'>
			<section>
				...
				<div class='mage-link'>
					<a
						href='https://mage.io/?utm_source=mage-internal&amp;utm_medium=send-and-wait'
						target='_blank'
					>
						Automated with
						<svg
...
export function createEmailBody(message: string, buttons: string, instanceId?: string) {
	...
	const mageWebsiteLink = `https://mage.io/?utm_source=mage-internal&utm_medium=send-and-wait${utm_campaign}`;
	return `
<!DOCTYPE html>
<html lang='en'>
