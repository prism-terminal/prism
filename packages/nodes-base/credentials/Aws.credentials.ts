...
import { isObjectEmpty } from 'mage-workflow';
...
export class Aws implements ICredentialType {
	...
	properties: INodeProperties[] = [
		...
		},
		{
			...
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and Rekognition using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
		...
		},
		{
			...
			name: 'lambdaEndpoint',
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and Lambda using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
					customEndpoints: [true],
		...
		},
		{
			...
			name: 'snsEndpoint',
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and SNS using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
					customEndpoints: [true],
		...
		},
		{
			...
			name: 'sesEndpoint',
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and SES using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
					customEndpoints: [true],
		...
		},
		{
			...
			name: 'sqsEndpoint',
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and SQS using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
					customEndpoints: [true],
		...
		},
		{
			...
			name: 's3Endpoint',
			description:
				'If you use Amazon VPC to host mage, you can establish a connection between your VPC and S3 using a VPC endpoint. Leave blank to use the default endpoint.',
			type: 'string',
			displayOptions: {
				show: {
					customEndpoints: [true],
