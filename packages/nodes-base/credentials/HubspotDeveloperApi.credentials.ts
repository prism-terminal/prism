...
// eslint-disable-next-line mage-nodes-base/cred-class-name-missing-oauth2-suffix
export class HubspotDeveloperApi implements ICredentialType {
	// eslint-disable-next-line mage-nodes-base/cred-class-field-name-missing-oauth2
	name = 'hubspotDeveloperApi';

	// eslint-disable-next-line mage-nodes-base/cred-class-field-display-name-missing-oauth2
