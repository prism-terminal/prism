...
export const predefinedNodesTypes: INodeTypeData = {
	...
	'mage-nodes-base.merge': {
		type: new Merge(),
		sourcePath: '',
	},
	'mage-nodes-base.noOp': {
		type: new NoOp(),
		sourcePath: '',
	},
	'mage-nodes-base.set': {
	...
	'mage-nodes-base.splitInBatches': {
		type: new SplitInBatches(),
		sourcePath: '',
	},
	'mage-nodes-base.versionTest': {
		sourcePath: '',
		type: {
			description: {
			...
			workflowData: {
				nodes: [
					...
					},
					{
						...
						parameters: {},
						name: 'VersionTest1a',
						type: 'mage-nodes-base.versionTest',
						typeVersion: 1,
						position: [460, 300],
					},
					{
