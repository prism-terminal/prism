...
import { NodeHelpers, NodeApiError, NodeOperationError, sleep } from 'mage-workflow';
import type {
...
export class RoutingNode {
	...
	async runPostReceiveAction(
		...
		responseData: ImageHttpFullResponse,
	...
	async rawRoutingRequest(
		...
		credentialsDecrypted?: ICredentialsDecrypted,
	): Promise<ImageHttpFullResponse> {
		let responseData: ImageHttpFullResponse;
