...
import type { INodeParameters, INode, ITaskData, IDataObject, IConnections } from 'mage-workflow';

interface StubNode {
	name: string;
	parameters?: INodeParameters;
	disabled?: boolean;
	type?: 'mage-nodes-base.manualTrigger' | 'mage-nodes-base.splitInBatches' | (string & {});
}
...
export function createNodeData(stubData: StubNode): INode {
	return {
		...
		type: stubData.type ?? 'mage-nodes-base.set',
		typeVersion: 1,
		id: 'uuid-1234',
		position: [100, 100],
