...
import type { IDataObject, INode, INodeType } from 'mage-workflow';
import { jsonParse, NodeOperationError } from 'mage-workflow';
import { z } from 'zod';
...
// This file is temporarily duplicated in `packages/@mage/nodes-langchain/nodes/tools/ToolWorkflow/v2/utils/FromAIParser.ts`
