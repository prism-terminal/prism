import { ITriggerFunctions, INodeType, INodeTypeDescription, ITriggerResponse } from 'mage-workflow';
...
export class ClassNameReplace implements INodeType {
	...
	async trigger(this: ITriggerFunctions): Promise<ITriggerResponse> {
		...
		// The "closeFunction" function gets called by mage whenever
		// the workflow gets deactivated and can so clean up.
		async function closeFunction() {
			clearInterval(intervalObj);
		}

		// The "manualTriggerFunction" function gets called by mage
