...
endOfMonth.doc = {
	...
	section: 'edit',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-endOfMonth',
};
...
isDst.doc = {
	...
	section: 'query',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-isDst',
};
...
isWeekend.doc = {
	...
	section: 'query',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-isWeekend',
};
...
beginningOf.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-beginningOf',
};
...
extract.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-extract',
};
...
format.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-format',
};
...
isBetween.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-isBetween',
};
...
isInLast.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-isInLast',
};
...
toDateTime.doc = {
	...
	returnType: 'DateTime',
	hidden: true,
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-toDateTime',
};
...
minus.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-minus',
};
...
plus.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-plus',
};
...
diffTo.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-diffTo',
};
...
diffToNow.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/dates/#date-diffToNow',
};
