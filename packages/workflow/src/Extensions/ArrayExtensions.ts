...
average.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-average',
};
...
compact.doc = {
	...
	returnType: 'Array',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-compact',
};
...
isEmpty.doc = {
	...
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-isEmpty',
};
...
isNotEmpty.doc = {
	...
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-isNotEmpty',
};
...
first.doc = {
	...
	returnType: 'any',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-first',
};
...
last.doc = {
	...
	returnType: 'any',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-last',
};
...
max.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-max',
};
...
min.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-min',
};
...
randomItem.doc = {
	...
	returnType: 'any',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-randomItem',
};
...
sum.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-sum',
};
...
chunk.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-chunk',
};
...
difference.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-difference',
};
...
intersection.doc = {
	...
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-intersection',
};
...
merge.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-merge',
};
...
pluck.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-pluck',
};
...
renameKeys.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-renameKeys',
};
...
smartJoin.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-smartJoin',
};
...
union.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-union',
};
...
unique.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-unique',
	args: [
		{
			name: 'fieldNames',
			optional: false,
...
toJsonString.doc = {
	...
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-toJsonString',
	returnType: 'string',
};
...
append.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/arrays/#array-append',
	returnType: 'Array',
	args: [
		{
			name: 'elements',
