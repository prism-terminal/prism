...
removeMarkdown.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-removeMarkdown',
...
removeTags.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-removeTags',
...
toDate.doc = {
	...
	returnType: 'Date',
	hidden: true,
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toDate',
};
...
toDateTime.doc = {
	...
	returnType: 'DateTime',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toDateTime',
	examples: [
...
toBoolean.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toBoolean',
	examples: [
...
toFloat.doc = {
	...
	hidden: true,
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toDecimalNumber',
};
...
toInt.doc = {
	...
	hidden: true,
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toInt',
};
...
toSentenceCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toSentenceCase',
};
...
toSnakeCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toSnakeCase',
};
...
toTitleCase.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toTitleCase',
};
...
urlEncode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-urlEncode',
	examples: [
...
urlDecode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-urlDecode',
	examples: [
...
replaceSpecialChars.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-replaceSpecialChars',
...
length.doc = {
	...
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings',
};
...
isDomain.doc = {
	...
	section: 'validation',
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isDomain',
	examples: [
		{ example: '"mage.io".isDomain()', evaluated: 'true' },
		{ example: '"http://mage.io".isDomain()', evaluated: 'false' },
...
isEmail.doc = {
	...
	section: 'validation',
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isEmail',
	examples: [
...
isNumeric.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isNumeric',
	examples: [
...
isUrl.doc = {
	...
	section: 'validation',
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isUrl',
	examples: [
		{ example: '"https://mage.io".isUrl()', evaluated: 'true' },
		{ example: '"mage.io".isUrl()', evaluated: 'false' },
...
isEmpty.doc = {
	...
	section: 'validation',
	returnType: 'boolean',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isEmpty',
	examples: [
...
isNotEmpty.doc = {
	...
	returnType: 'boolean',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-isNotEmpty',
	examples: [
...
extractEmail.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-extractEmail',
	examples: [
...
extractDomain.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-extractDomain',
	examples: [
		{ example: '"me@example.com".extractDomain()', evaluated: "'example.com'" },
		{ example: '"http://mage.io/workflows".extractDomain()', evaluated: "'mage.io'" },
		{
...
extractUrl.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-extractUrl',
	examples: [{ example: '"Check out http://mage.io".extractUrl()', evaluated: "'http://mage.io'" }],
};
...
extractUrlPath.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-extractUrlPath',
	examples: [
		{ example: '"http://mage.io/workflows".extractUrlPath()', evaluated: "'/workflows'" },
		{
			example: '"Check out http://mage.io/workflows".extractUrl().extractUrlPath()',
			evaluated: "'/workflows'",
		},
	],
};
...
hash.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-hash',
...
quote.doc = {
	...
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-quote',
...
parseJson.doc = {
	...
	returnType: 'any',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-parseJson',
	examples: [
...
base64Encode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-base64Encode',
};
...
base64Decode.doc = {
	...
	returnType: 'string',
	docURL:
		'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-base64Decode',
};
...
toNumber.doc = {
	...
	section: 'cast',
	returnType: 'number',
	docURL: 'https://docs.mage.io/code/builtin/data-transformation-functions/strings/#string-toNumber',
	examples: [
