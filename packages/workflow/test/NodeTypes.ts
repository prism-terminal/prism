...
const stickyNode: LoadedClass<INodeType> = {
	type: {
		description: {
			...
			name: 'mage-nodes-base.stickyNote',
			icon: 'fa:sticky-note',
			group: ['input'],
			version: 1,
...
const manualTriggerNode: LoadedClass<INodeType> = {
	...
	type: {
		description: {
			...
			name: 'mage-nodes-base.manualTrigger',
			icon: 'fa:mouse-pointer',
			group: ['trigger'],
			version: 1,
			description: 'Runs the flow on clicking a button in mage',
...
export class NodeTypes implements INodeTypes {
	nodeTypes: INodeTypeData = {
		'mage-nodes-base.stickyNote': stickyNode,
		'mage-nodes-base.set': setNode,
		...
		'mage-nodes-base.manualTrigger': manualTriggerNode,
	};
