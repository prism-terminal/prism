...
export type mageConnectorOptions = ConnectorOptions;
interface mageConnectorPaintGeometry extends PaintGeometry {
...
export class mageConnector extends AbstractConnector {
	static type = 'mageConnector';

	type = mageConnector.type;
	...
	writeFlowchartSegments(paintInfo: mageConnectorPaintGeometry) {
	...
	_getPaintInfo(params: ConnectorComputeParams): mageConnectorPaintGeometry {
	...
	_computeBezier(paintInfo: mageConnectorPaintGeometry) {
	...
	_computeFlowchart(paintInfo: mageConnectorPaintGeometry) {
		this.segments = [];
		this.lastx = null;
		this.lasty = null;
