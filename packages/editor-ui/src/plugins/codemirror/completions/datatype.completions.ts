...
import type { DocMetadata, IDataObject, NativeDoc } from 'mage-workflow';
import { Expression, ExpressionExtensions, NativeMethods, validateFieldType } from 'mage-workflow';
import {
	...
	return variables.map((variable) =>
		createCompletionOption({
			...
			doc: {
				...
				docURL: 'https://docs.mage.io/environments/variables/',
			},
		}),
	);
};
	...
	return [
		{
			name: 'statusCode',
			returnType: 'number',
			docURL: 'https://docs.mage.io/code/builtin/http-node-variables/',
...
export const executionOptions = () => {
	return [
...

		{
			name: 'resumeUrl',
			returnType: 'string',
			docURL: 'https://docs.mage.io/integrations/builtin/core-nodes/mage-nodes-base.wait/',
		...
		},
		{
			...
			docURL: 'https://docs.mage.io/workflows/executions/custom-executions-data/',
	...
	const options: Array<{ doc: DocMetadata; isFunction?: boolean }> = [
		{
			doc: {
				name: 'item',
				returnType: 'Item',
				docURL: 'https://docs.mage.io/data/data-mapping/data-item-linking/',
	...
	return [
		{
			name: 'json',
			returnType: 'Object',
			docURL: 'https://docs.mage.io/data/data-structure/',
