...
import { mageAddInputEndpoint } from './mageAddInputEndpointType';

export const register = () => {
	registerEndpointRenderer<mageAddInputEndpoint>(mageAddInputEndpoint.type, {
		makeNode: (endpointInstance: mageAddInputEndpoint) => {
			const xOffset = 1;
			const lineYOffset = -2;
