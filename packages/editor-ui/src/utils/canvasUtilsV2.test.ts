...
import type { IConnections, INodeTypeDescription, IConnection } from 'mage-workflow';
...
describe('mapLegacyConnectionsToCanvasConnections', () => {
	...
	// @issue https://linear.app/mage/issue/mage-7880/cannot-load-some-templates
