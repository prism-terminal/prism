...
import { ApplicationError, jsonParse, type GenericValue, type IDataObject } from 'mage-workflow';
...
export async function request(config: {
	...
	if (
		...
		!baseURL.includes('api.mage.io') &&
		!baseURL.includes('mage.cloud')
	) {
	...
	try {
		...
		if (error.message === 'Network Error') {
			throw new ResponseError("Can't connect to mage.", {
