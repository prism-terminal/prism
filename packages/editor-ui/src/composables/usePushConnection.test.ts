...
import type { PushMessage, PushPayload } from '@mage/api-types';
import type { ITaskData, WorkflowOperationError, IRunData } from 'mage-workflow';
					...
					data: {
						...
						rawData: stringify({
							...
							resultData: {
								...
								error: {
									message:
										'Your trial has ended. <a href="https://app.mage.cloud/account/change-plan">Upgrade now</a> to keep automating',
									name: 'NodeApiError',
									node: 'Last Node',
