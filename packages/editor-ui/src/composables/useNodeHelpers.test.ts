...
describe('useNodeHelpers()', () => {
	...
	describe('isSingleExecution', () => {
		...
		test('should determine based on node parameters if it would be executed once', () => {
			expect(isSingleExecution('mage-nodes-base.code', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.code', { mode: 'runOnceForEachItem' })).toEqual(
				false,
			);
			expect(isSingleExecution('mage-nodes-base.executeWorkflow', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.executeWorkflow', { mode: 'each' })).toEqual(false);
			expect(isSingleExecution('mage-nodes-base.crateDb', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.crateDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.timescaleDb', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.timescaleDb', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('mage-nodes-base.microsoftSql', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.microsoftSql', { operation: 'update' })).toEqual(
				true,
			);
			expect(isSingleExecution('mage-nodes-base.microsoftSql', { operation: 'delete' })).toEqual(
				true,
			);
			expect(isSingleExecution('mage-nodes-base.questDb', {})).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.mongoDb', { operation: 'insert' })).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.mongoDb', { operation: 'update' })).toEqual(true);
			expect(isSingleExecution('mage-nodes-base.redis', {})).toEqual(true);
		});
	});
});
