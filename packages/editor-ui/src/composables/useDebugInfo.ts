...
import type { WorkflowSettings } from 'mage-workflow';
...
type DebugInfo = {
	...
	security?: {
		...
		blockFileAccessTomageFiles?: boolean;
	};
	client: {
		userAgent: string;
...
export function useDebugInfo() {
	...
	const securityInfo = () => {
		...
		if (!settingsStore.security.blockFileAccessTomageFiles) info.blockFileAccessTomageFiles = false;
