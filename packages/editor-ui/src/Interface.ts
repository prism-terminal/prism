...
import type { NodeCreatorTag } from 'mage-design-system';
import type {
	GenericValue,
	IConnections,
...
export * from 'mage-design-system/types';
...
// Simple version of mage-workflow.Workflow
