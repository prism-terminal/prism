...
<template>
	<div v-if="!isLDAPFeatureEnabled">
		...
		<mage-info-tip type="note" theme="info" tooltip-placement="right" class="mb-l">
	...
	<div v-else>
		<div :class="$style.container">
			...
			<div :class="$style.docsInfoTip">
				<mage-info-tip theme="info" type="note">
					<span v-mage-html="i18n.baseText('settings.ldap.infoTip')"></span>
				</mage-info-tip>
			</div>
		...
		<div v-if="loginEnabled">
			<mage-heading tag="h1" class="mb-xl mt-3xl" size="medium">{{
