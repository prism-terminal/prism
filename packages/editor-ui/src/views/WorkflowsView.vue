	...
	>
		...
		<template #empty>
			<div class="text-center mt-s">
				<mageHeading tag="h2" size="xlarge" class="mb-2xs">
					{{
				...
				<mageText size="large" color="text-base">
			...
			>
				<mageCard
					...
					@click="addWorkflow"
				>
					<mageIcon :class="$style.emptyStateCardIcon" icon="file" />
					<mageText size="large" class="mt-xs" color="text-dark">
				...
				>
					<mageIcon :class="$style.emptyStateCardIcon" icon="robot" />
					<mageText size="large" class="mt-xs pl-2xs pr-2xs" color="text-dark">
