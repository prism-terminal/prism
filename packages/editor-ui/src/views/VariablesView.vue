...
import { uid } from 'mage-design-system/utils';
...
<template>
	...
	>
		<template #header>
			<mage-heading size="2xlarge" class="mb-m">
				{{ i18n.baseText('variables.heading') }}
			</mage-heading>
		</template>
		<template #add-button>
			<mage-tooltip placement="top" :disabled="canCreateVariables">
				<div>
					<mage-button
						size="large"
						block
...
@use 'mage-design-system/css/common/var.scss';
