...
<template>
	<div class="pb-3xl">
		<mage-heading size="2xlarge">{{ i18n.baseText('settings.sso.title') }}</mage-heading>
		<div :class="$style.top">
			<mage-heading size="xlarge">{{ i18n.baseText('settings.sso.subtitle') }}</mage-heading>
			<mage-tooltip
		...
		<mage-info-tip>
			...
			<a href="https://docs.mage.io/user-management/saml/" target="_blank">
		...
		<div v-if="ssoStore.isEnterpriseSamlEnabled" data-test-id="sso-content-licensed">
			...
			<div :class="$style.group">
				...
				<div class="mt-2xs mb-s">
					<mage-radio-buttons v-model="ipsType" :options="ipsOptions" />
				</div>
			...
			<div :class="$style.buttons">
				<mage-button :disabled="!isSaveEnabled" size="large" data-test-id="sso-save" @click="onSave">
