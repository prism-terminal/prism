...
<template>
	<div :class="$style.container">
		<div>
			<mage-heading size="2xlarge">{{ i18n.baseText('settings.users') }}</mage-heading>
			<div v-if="!showUMSetupWarning" :class="$style.buttonContainer">
				<mage-tooltip :disabled="!ssoStore.isSamlLoginEnabled">
					<template #content>
		...
		<mage-notice v-if="!isAdvancedPermissionsEnabled">
			<i18n-t keypath="settings.users.advancedPermissions.warning">
				<template #link>
					<mage-link size="small" @click="goToUpgradeAdvancedPermissions">
