...
<template>
	<div>
		...
		<template v-if="isLicensed">
			<div class="mb-l">
				<mage-info-tip theme="info" type="note">
					<span v-mage-html="i18n.baseText('settings.log-streaming.infoText')"></span>
				</mage-info-tip>
			</div>
			<template v-if="storeHasItems()">
				...
				<div class="mt-m text-right">
					<mage-button v-if="canManageLogStreaming" size="large" @click="addDestination">
			...
			<div v-else data-test-id="action-box-licensed">
				...
				>
					<template #heading>
						<span v-mage-html="i18n.baseText(`settings.log-streaming.addFirstTitle`)" />
					</template>
				</mage-action-box>
			</div>
		</template>
		<template v-else>
			...
			<div data-test-id="action-box-unlicensed">
				...
				>
					<template #heading>
						<span v-mage-html="i18n.baseText('settings.log-streaming.actionBox.title')" />
					</template>
				</mage-action-box>
			</div>
		</template>
