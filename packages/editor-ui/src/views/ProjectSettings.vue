...
const nameInput = ref<InstanceType<typeof mageFormInput> | null>(null);
			...
			<fieldset :class="$style.buttons">
				<div>
					...
					<mageButton
						...
						>{{ i18n.baseText('projects.settings.button.cancel') }}</mageButton
					>
				</div>
				<mageButton
					...
					>{{ i18n.baseText('projects.settings.button.save') }}</mageButton
				>
			</fieldset>
			<fieldset>
				<hr class="mb-2xl" />
				...
				<mageButton
					...
					>{{ i18n.baseText('projects.settings.danger.deleteProject') }}</mageButton
				>
			</fieldset>
		</form>
		<ProjectDeleteDialog
