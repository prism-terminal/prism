...
const testTemplate1 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			mockTemplateNode('IMAP Email', 'mage-nodes-base.emailReadImap'),
			mockTemplateNode('Nextcloud', 'mage-nodes-base.nextCloud'),
		],
	},
	full: true,
});
...
const testTemplate2 = mock<ITemplatesWorkflowFull>({
	...
	workflow: {
		nodes: [
			{
				...mockTemplateNode('Telegram', 'mage-nodes-base.telegram'),
				credentials: {
			...
			expect(setupTemplateStore.credentialUsages).toEqual([
				{
					...
					credentialType: 'imap',
					key: 'imap-',
					nodeTypeName: 'mage-nodes-base.emailReadImap',
				...
				},
				{
					...
					key: 'nextCloudApi-',
					nodeTypeName: 'mage-nodes-base.nextCloud',
