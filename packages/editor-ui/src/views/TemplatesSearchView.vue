		...
		<template #header>
			<div :class="$style.wrapper">
				<div :class="$style.title">
					<mage-heading tag="h1" size="2xlarge">
				...
				<div :class="$style.search">
					...
					<div v-show="collections.length || loadingCollections" :class="$style.carouselContainer">
						<div :class="$style.header">
							<mage-heading :bold="true" size="medium" color="text-light">
					...
					<div v-if="endOfSearchMessage" :class="$style.endText">
						<mage-text size="medium" color="text-base">
							<span v-mage-html="endOfSearchMessage" />
						</mage-text>
					</div>
				</div>
			</div>
