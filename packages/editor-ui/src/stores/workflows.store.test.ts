...
import { SEND_AND_WAIT_OPERATION } from 'mage-workflow';
import type { IPinData, ExecutionSummary, IConnection, INodeExecutionData } from 'mage-workflow';
import { stringSizeInBytes } from '@/utils/typesUtils';
import { dataPinningEventBus } from '@/event-bus';
import { useUIStore } from '@/stores/ui.store';
import type { PushPayload } from '@mage/api-types';
		...
		it('should add node error event and track errored executions', async () => {
			...
			expect(track).toHaveBeenCalledWith(
				'Manual exec errored',
				{
					...
					node_type: 'mage-nodes-base.set',
					node_type_version: 3.4,
					node_id: '554c7ff4-7ee2-407c-8931-e34234c5056a',
					node_graph_string:
						'{"node_types":["mage-nodes-base.set"],"node_connections":[],"nodes":{"0":{"id":"554c7ff4-7ee2-407c-8931-e34234c5056a","type":"mage-nodes-base.set","version":3.4,"position":[680,180]}},"notes":{},"is_pinned":false}',
				},
				{
					withPostHog: true,
				},
