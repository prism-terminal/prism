...
import type { IDataObject, INodeInputConfiguration, NodeParameterValueType } from 'mage-workflow';
import { NodeConnectionType, nodeConnectionTypes, NodeHelpers } from 'mage-workflow';
