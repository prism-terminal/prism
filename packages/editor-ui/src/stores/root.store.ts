...
import { randomString, setGlobalState } from 'mage-workflow';
...
export const useRootStore = defineStore(STORES.ROOT, () => {
	...
	const restCloudApiContext = computed(() => ({
		baseUrl: window.location.host.includes('stage-app.mage.cloud')
	...
	const setmageMetadata = (metadata: RootState['mageMetadata']) => {
		state.value.mageMetadata = metadata;
	};
