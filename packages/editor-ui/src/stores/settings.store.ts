...
import type { IUserManagementSettings, FrontendSettings } from '@mage/api-types';
...
import type { IDataObject, WorkflowSettings } from 'mage-workflow';
import { ExpressionEvaluatorProxy } from 'mage-workflow';
...
export const useSettingsStore = defineStore(STORES.SETTINGS, () => {
	...
	const security = computed(() => ({
		blockFileAccessTomageFiles: settings.value.security.blockFileAccessTomageFiles,
	...
	const getSettings = async () => {
		...
		rootStore.setmageMetadata(fetchedSettings.mageMetadata || {});
