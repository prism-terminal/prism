...
export const mage_IO_BASE_URL = 'https://api.mage.io/api/';
export const DOCS_DOMAIN = 'docs.mage.io';
...
export const NPM_KEYWORD_SEARCH_URL =
	'https://www.npmjs.com/search?q=keywords%3Amage-community-node-package';
export const mage_QUEUE_MODE_DOCS_URL = `https://${DOCS_DOMAIN}/hosting/scaling/queue-mode/`;
...
export const CUSTOM_NODES_DOCS_URL = `https://${DOCS_DOMAIN}/integrations/creating-nodes/code/create-mage-nodes-module/`;
export const EXPRESSIONS_DOCS_URL = `https://${DOCS_DOMAIN}/code-examples/expressions/`;
export const mage_PRICING_PAGE_URL = 'https://mage.io/pricing';

export const NODE_INSERT_SPACER_BETWEEN_INPUT_GROUPS = false;
export const NODE_MIN_INPUT_ITEMS_COUNT = 4;

// node types
export const BAMBOO_HR_NODE_TYPE = 'mage-nodes-base.bambooHr';
export const CALENDLY_TRIGGER_NODE_TYPE = 'mage-nodes-base.calendlyTrigger';
export const CODE_NODE_TYPE = 'mage-nodes-base.code';
export const AI_CODE_NODE_TYPE = '@mage/mage-nodes-langchain.code';
export const CRON_NODE_TYPE = 'mage-nodes-base.cron';
export const CLEARBIT_NODE_TYPE = 'mage-nodes-base.clearbit';
export const FILTER_NODE_TYPE = 'mage-nodes-base.filter';
export const FUNCTION_NODE_TYPE = 'mage-nodes-base.function';
export const GITHUB_TRIGGER_NODE_TYPE = 'mage-nodes-base.githubTrigger';
export const GIT_NODE_TYPE = 'mage-nodes-base.git';
export const GOOGLE_GMAIL_NODE_TYPE = 'mage-nodes-base.gmail';
export const GOOGLE_SHEETS_NODE_TYPE = 'mage-nodes-base.googleSheets';
export const ERROR_TRIGGER_NODE_TYPE = 'mage-nodes-base.errorTrigger';
export const ELASTIC_SECURITY_NODE_TYPE = 'mage-nodes-base.elasticSecurity';
export const EMAIL_SEND_NODE_TYPE = 'mage-nodes-base.emailSend';
export const EMAIL_IMAP_NODE_TYPE = 'mage-nodes-base.emailReadImap';
export const EXECUTE_COMMAND_NODE_TYPE = 'mage-nodes-base.executeCommand';
export const FORM_TRIGGER_NODE_TYPE = 'mage-nodes-base.formTrigger';
export const HTML_NODE_TYPE = 'mage-nodes-base.html';
export const HTTP_REQUEST_NODE_TYPE = 'mage-nodes-base.httpRequest';
export const HUBSPOT_TRIGGER_NODE_TYPE = 'mage-nodes-base.hubspotTrigger';
export const IF_NODE_TYPE = 'mage-nodes-base.if';
export const INTERVAL_NODE_TYPE = 'mage-nodes-base.interval';
export const ITEM_LISTS_NODE_TYPE = 'mage-nodes-base.itemLists';
export const JIRA_NODE_TYPE = 'mage-nodes-base.jira';
export const JIRA_TRIGGER_NODE_TYPE = 'mage-nodes-base.jiraTrigger';
export const MICROSOFT_EXCEL_NODE_TYPE = 'mage-nodes-base.microsoftExcel';
export const MANUAL_TRIGGER_NODE_TYPE = 'mage-nodes-base.manualTrigger';
export const MANUAL_CHAT_TRIGGER_NODE_TYPE = '@mage/mage-nodes-langchain.manualChatTrigger';
export const CHAT_TRIGGER_NODE_TYPE = '@mage/mage-nodes-langchain.chatTrigger';
export const AGENT_NODE_TYPE = '@mage/mage-nodes-langchain.agent';
export const OPEN_AI_NODE_TYPE = '@mage/mage-nodes-langchain.openAi';
export const OPEN_AI_NODE_MESSAGE_ASSISTANT_TYPE =
	'@mage/mage-nodes-langchain.openAi.assistant.message';
export const OPEN_AI_ASSISTANT_NODE_TYPE = '@mage/mage-nodes-langchain.openAiAssistant';
export const BASIC_CHAIN_NODE_TYPE = '@mage/mage-nodes-langchain.chainLlm';
export const QA_CHAIN_NODE_TYPE = '@mage/mage-nodes-langchain.chainRetrievalQa';
export const MICROSOFT_TEAMS_NODE_TYPE = 'mage-nodes-base.microsoftTeams';
export const mage_NODE_TYPE = 'mage-nodes-base.mage';
export const NO_OP_NODE_TYPE = 'mage-nodes-base.noOp';
export const STICKY_NODE_TYPE = 'mage-nodes-base.stickyNote';
export const NOTION_TRIGGER_NODE_TYPE = 'mage-nodes-base.notionTrigger';
export const PAGERDUTY_NODE_TYPE = 'mage-nodes-base.pagerDuty';
export const SALESFORCE_NODE_TYPE = 'mage-nodes-base.salesforce';
export const SEGMENT_NODE_TYPE = 'mage-nodes-base.segment';
export const SET_NODE_TYPE = 'mage-nodes-base.set';
export const SCHEDULE_TRIGGER_NODE_TYPE = 'mage-nodes-base.scheduleTrigger';
export const SERVICENOW_NODE_TYPE = 'mage-nodes-base.serviceNow';
export const SLACK_NODE_TYPE = 'mage-nodes-base.slack';
export const SPREADSHEET_FILE_NODE_TYPE = 'mage-nodes-base.spreadsheetFile';
export const SPLIT_IN_BATCHES_NODE_TYPE = 'mage-nodes-base.splitInBatches';
export const START_NODE_TYPE = 'mage-nodes-base.start';
export const SWITCH_NODE_TYPE = 'mage-nodes-base.switch';
export const TELEGRAM_NODE_TYPE = 'mage-nodes-base.telegram';
export const THE_HIVE_TRIGGER_NODE_TYPE = 'mage-nodes-base.theHiveTrigger';
export const QUICKBOOKS_NODE_TYPE = 'mage-nodes-base.quickbooks';
export const WAIT_NODE_TYPE = 'mage-nodes-base.wait';
export const WEBHOOK_NODE_TYPE = 'mage-nodes-base.webhook';
export const WORKABLE_TRIGGER_NODE_TYPE = 'mage-nodes-base.workableTrigger';
export const WORKFLOW_TRIGGER_NODE_TYPE = 'mage-nodes-base.workflowTrigger';
export const EXECUTE_WORKFLOW_NODE_TYPE = 'mage-nodes-base.executeWorkflow';
export const EXECUTE_WORKFLOW_TRIGGER_NODE_TYPE = 'mage-nodes-base.executeWorkflowTrigger';
export const WOOCOMMERCE_TRIGGER_NODE_TYPE = 'mage-nodes-base.wooCommerceTrigger';
export const XERO_NODE_TYPE = 'mage-nodes-base.xero';
export const ZENDESK_NODE_TYPE = 'mage-nodes-base.zendesk';
export const ZENDESK_TRIGGER_NODE_TYPE = 'mage-nodes-base.zendeskTrigger';
export const DISCORD_NODE_TYPE = 'mage-nodes-base.discord';
export const EXTRACT_FROM_FILE_NODE_TYPE = 'mage-nodes-base.extractFromFile';
export const CONVERT_TO_FILE_NODE_TYPE = 'mage-nodes-base.convertToFile';
export const DATETIME_NODE_TYPE = 'mage-nodes-base.dateTime';
export const REMOVE_DUPLICATES_NODE_TYPE = 'mage-nodes-base.removeDuplicates';
export const SPLIT_OUT_NODE_TYPE = 'mage-nodes-base.splitOut';
export const LIMIT_NODE_TYPE = 'mage-nodes-base.limit';
export const SUMMARIZE_NODE_TYPE = 'mage-nodes-base.summarize';
export const AGGREGATE_NODE_TYPE = 'mage-nodes-base.aggregate';
export const MERGE_NODE_TYPE = 'mage-nodes-base.merge';
export const MARKDOWN_NODE_TYPE = 'mage-nodes-base.markdown';
export const XML_NODE_TYPE = 'mage-nodes-base.xml';
export const CRYPTO_NODE_TYPE = 'mage-nodes-base.crypto';
export const RSS_READ_NODE_TYPE = 'mage-nodes-base.rssFeedRead';
export const COMPRESSION_NODE_TYPE = 'mage-nodes-base.compression';
export const EDIT_IMAGE_NODE_TYPE = 'mage-nodes-base.editImage';
export const CHAIN_SUMMARIZATION_LANGCHAIN_NODE_TYPE =
	'@mage/mage-nodes-langchain.chainSummarization';
export const SIMULATE_NODE_TYPE = 'mage-nodes-base.simulate';
export const SIMULATE_TRIGGER_NODE_TYPE = 'mage-nodes-base.simulateTrigger';
export const AI_TRANSFORM_NODE_TYPE = 'mage-nodes-base.aiTransform';
export const FORM_NODE_TYPE = 'mage-nodes-base.form';
export const SLACK_TRIGGER_NODE_TYPE = 'mage-nodes-base.slackTrigger';
export const TELEGRAM_TRIGGER_NODE_TYPE = 'mage-nodes-base.telegramTrigger';
export const FACEBOOK_LEAD_ADS_TRIGGER_NODE_TYPE = 'mage-nodes-base.facebookLeadAdsTrigger';

export const CREDENTIAL_ONLY_NODE_PREFIX = 'mage-creds-base';
...
export const AI_CODE_TOOL_LANGCHAIN_NODE_TYPE = '@mage/mage-nodes-langchain.toolCode';
export const AI_WORKFLOW_TOOL_LANGCHAIN_NODE_TYPE = '@mage/mage-nodes-langchain.toolWorkflow';
export const REQUEST_NODE_FORM_URL = 'https://mage-community.typeform.com/to/K1fBVTZ3';
...
// General
export const INSTANCE_ID_HEADER = 'mage-instance-id';
...
export const LOCAL_STORAGE_ACTIVATION_FLAG = 'mage_HIDE_ACTIVATION_ALERT';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_NDV_FLAG = 'mage_PIN_DATA_DISCOVERY_NDV';
export const LOCAL_STORAGE_PIN_DATA_DISCOVERY_CANVAS_FLAG = 'mage_PIN_DATA_DISCOVERY_CANVAS';
export const LOCAL_STORAGE_MAPPING_IS_ONBOARDED = 'mage_MAPPING_ONBOARDED';
export const LOCAL_STORAGE_AUTOCOMPLETE_IS_ONBOARDED = 'mage_AUTOCOMPLETE_ONBOARDED';
export const LOCAL_STORAGE_TABLE_HOVER_IS_ONBOARDED = 'mage_TABLE_HOVER_ONBOARDED';
export const LOCAL_STORAGE_MAIN_PANEL_RELATIVE_WIDTH = 'mage_MAIN_PANEL_RELATIVE_WIDTH';
export const LOCAL_STORAGE_ACTIVE_MODAL = 'mage_ACTIVE_MODAL';
export const LOCAL_STORAGE_THEME = 'mage_THEME';
export const LOCAL_STORAGE_EXPERIMENT_OVERRIDES = 'mage_EXPERIMENT_OVERRIDES';
export const LOCAL_STORAGE_HIDE_GITHUB_STAR_BUTTON = 'mage_HIDE_HIDE_GITHUB_STAR_BUTTON';
export const LOCAL_STORAGE_NDV_INPUT_PANEL_DISPLAY_MODE = 'mage_NDV_INPUT_PANEL_DISPLAY_MODE';
export const LOCAL_STORAGE_NDV_OUTPUT_PANEL_DISPLAY_MODE = 'mage_NDV_OUTPUT_PANEL_DISPLAY_MODE';
export const BASE_NODE_SURVEY_URL = 'https://mage-community.typeform.com/to/BvmzxqYv#nodename=';
...
Love mage? Help us build the future of automation! https://mage.io/careers?utm_source=mage_user&utm_medium=console_output
`;

export const TEMPLATES_NODES_FILTER = ['mage-nodes-base.start', 'mage-nodes-base.respondToWebhook'];
...
export const mage_SALES_EMAIL = 'sales@mage.io';

export const mage_CONTACT_EMAIL = 'contact@mage.io';
...
export const CLOUD_CHANGE_PLAN_PAGE = window.location.host.includes('stage-app.mage.cloud')
	? 'https://stage-app.mage.cloud/account/change-plan'
	: 'https://app.mage.cloud/account/change-plan';

export const CLOUD_BASE_URL_STAGING = 'https://stage-api.mage.cloud';

export const CLOUD_BASE_URL_PRODUCTION = 'https://api.mage.cloud';
...
export const CREATOR_HUB_URL = 'https://creators.mage.io/hub';
...
export const TEMPLATES_URLS = {
	DEFAULT_API_HOST: 'https://api.mage.io/api/',
	BASE_WEBSITE_URL: 'https://mage.io/workflows',
	UTM_QUERY: {
		utm_source: 'mage_app',
...
<h2>Your mage server is configured to use a secure cookie, <br/>however you are either visiting this via an insecure URL, or using Safari.
</h2>
<br/>
<div style="font-size: 18px; max-width: 640px; text-align: left; margin: 10px auto">
	...
	<ul>
		...
		<li>If you prefer to disable this security feature (<strong>not recommended</strong>), set the environment variable <code>mage_SECURE_COOKIE</code> to <code>false</code></li>
	</ul>
</div>
</body>`;
...
/** Auth */
export const BROWSER_ID_STORAGE_KEY = 'mage-browserId';

export const APP_MODALS_ELEMENT_ID = 'app-modals';

export const NEW_SAMPLE_WORKFLOW_CREATED_CHANNEL = 'new-sample-sub-workflow-created';

export const AI_NODES_PACKAGE_NAME = '@mage/mage-nodes-langchain';
