...
import type { ExecutionStatus, INodeConnections, NodeConnectionType } from 'mage-workflow';
import type {
	DefaultEdge,
	Node,
	NodeProps,
...
export const enum CanvasNodeRenderType {
	Default = 'default',
	StickyNote = 'mage-nodes-base.stickyNote',
	AddNodes = 'mage-nodes-internal.addNodes',
}
