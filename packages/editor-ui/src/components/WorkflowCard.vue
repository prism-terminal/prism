...
<template>
	<mage-card :class="$style.cardLink" @click="onClick">
		<template #header>
			<mage-heading tag="h2" bold :class="$style.cardHeading" data-test-id="workflow-card-name">
				{{ data.name }}
				<mageBadge v-if="!workflowPermissions.update" class="ml-3xs" theme="tertiary" bold>
