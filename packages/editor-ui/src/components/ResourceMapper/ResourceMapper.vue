...
import { NodeHelpers } from 'mage-workflow';
...
import { mageButton, mageCallout } from 'mage-design-system';
...
<template>
	<div class="mt-4xs" data-test-id="resource-mapper-container">
		...
		/>
		<mageText v-if="!showMappingModeSelect && state.loading" size="small">
		...
		<MappingFields
			...
			@refresh-field-list="initFetching(true)"
		/>
		<mageCallout v-else-if="state.hasStaleFields" theme="info" :iconless="true">
