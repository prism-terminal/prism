...
import type { INodePropertyTypeOptions, ResourceMapperFields } from 'mage-workflow';
import { computed, ref, watch } from 'vue';
import { i18n as locale } from '@/plugins/i18n';
import { useNodeSpecificationValues } from '@/composables/useNodeSpecificationValues';
import { mageInputLabel, mageSelect, mageText } from 'mage-design-system';
				...
				>
					...
					>
						<div class="list-option">
							...
							<div class="option-description" v-mage-html="option.description" />
						</div>
					</mageOption>
				</mageSelect>
			</div>
			<div class="mt-5xs">
				<mageText v-if="loading" size="small">
					<mageIcon icon="sync-alt" size="xsmall" :spin="true" />
					{{
				...
				<mageText v-else-if="errorMessage !== ''" size="small" color="danger">
					<mageIcon icon="exclamation-triangle" size="xsmall" />
					{{ errorMessage }}
					<mageLink size="small" theme="danger" :underline="true" @click="onRetryClick">
