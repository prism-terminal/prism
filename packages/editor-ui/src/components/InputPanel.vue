...
import type { INodeInputConfiguration, INodeOutputConfiguration, Workflow } from 'mage-workflow';
...
import { mageRadioButtons, mageTooltip, mageText } from 'mage-design-system';
...
<template>
	...
	>
		...
		<template #node-not-run>
			...
			>
				<mageText tag="div" :bold="true" color="text-dark" size="large">{{
					i18n.baseText('ndv.input.noOutputData.title')
				}}</mageText>
				<mageTooltip v-if="!readOnly" :visible="showDraggableHint && showDraggableHintWithDelay">
					<template #content>
						<div
							v-mage-html="
				...
				<mageText v-if="!readOnly" tag="div" size="small">
			...
			<div v-else :class="$style.notConnected">
				...
				<mageText tag="div">
					...
					<a
						href="https://docs.mage.io/workflows/connections/"
						target="_blank"
		...
		<template #node-waiting>
			<mageText :bold="true" color="text-dark" size="large">Waiting for input</mageText>
			<mageText v-mage-html="waitingMessage"></mageText>
		</template>
