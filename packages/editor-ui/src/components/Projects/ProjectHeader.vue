...
import { mageButton } from 'mage-design-system';
	...
	<div>
		<div :class="[$style.projectHeader]">
			<div :class="[$style.icon]">
				<mageIcon :icon="headerIcon" color="text-light"></mageIcon>
			</div>
			<div>
				<mageHeading bold tag="h2" size="xlarge">{{ projectName }}</mageHeading>
				<mageText color="text-light">
					<slot name="subtitle">
