...
<template>
	<Modal width="500px" :name="props.modalName" data-test-id="project-move-resource-modal">
		<template #header>
			<mageHeading tag="h2" size="xlarge" class="mb-m pr-s">
				{{
		...
		<template #footer>
			<div :class="$style.buttons">
				<mageButton type="secondary" text class="mr-2xs" @click="closeModal">
					{{ i18n.baseText('generic.cancel') }}
				</mageButton>
				<mageButton :disabled="!projectId" type="primary" @click="moveResource">
					{{
