	...
	>
		...
		<div :class="$style.status">
			...
			>
				...
				<mage-icon :class="$style.statusIcon" icon="check-circle" size="medium" color="text-light" />
			</mage-tooltip>
			...
			>
				...
				<mage-icon :class="$style.statusIcon" icon="times-circle" size="medium" color="text-light" />
			</mage-tooltip>
		</div>
	</div>
</template>
