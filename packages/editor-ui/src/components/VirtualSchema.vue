...
import { NodeConnectionType, type IConnectedNode, type IDataObject } from 'mage-workflow';
...
<template>
	<div class="run-data-schema full-height">
		<div v-if="noSearchResults" class="no-results">
			<mageText tag="h3" size="large">{{ i18n.baseText('ndv.search.noNodeMatch.title') }}</mageText>
			<mageText>
