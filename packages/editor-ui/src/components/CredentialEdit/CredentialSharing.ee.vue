...
import type { ICredentialDataDecryptedObject } from 'mage-workflow';
...
<template>
	<div :class="$style.container">
		...
		<div v-else>
			<mageInfoTip v-if="credentialPermissions.share" :bold="false" class="mb-s">
				{{ i18n.baseText('credentialEdit.credentialSharing.info.owner') }}
			</mageInfoTip>
			<mageInfoTip v-else-if="isHomeTeamProject" :bold="false" class="mb-s">
				{{ i18n.baseText('credentialEdit.credentialSharing.info.sharee.team') }}
			</mageInfoTip>
			<mageInfoTip v-else :bold="false" class="mb-s">
				{{
