...
import { type ResizeData } from 'mage-design-system';

const LOCAL_STORAGE_PANEL_HEIGHT = 'mage_CANVAS_CHAT_HEIGHT';
const LOCAL_STORAGE_PANEL_WIDTH = 'mage_CANVAS_CHAT_WIDTH';
