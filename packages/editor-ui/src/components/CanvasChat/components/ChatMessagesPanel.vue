...
import type { ChatMessage, ChatMessageText } from '@mage/chat/types';
import { useI18n } from '@/composables/useI18n';
import MessagesList from '@mage/chat/components/MessagesList.vue';
...
import type { ArrowKeyDownPayload } from '@mage/chat/components/Input.vue';
import ChatInput from '@mage/chat/components/Input.vue';
