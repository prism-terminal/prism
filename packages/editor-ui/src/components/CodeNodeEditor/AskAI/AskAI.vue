...
import { mageButton, mageInput, mageTooltip } from 'mage-design-system/components';
import { randomInt } from 'mage-workflow';
import type { CodeExecutionMode, INodeExecutionData } from 'mage-workflow';
	...
	<div>
		...
		<div :class="$style.inputContainer">
			<div :class="$style.meta">
				...
				/>
				<a href="https://docs.mage.io/code-examples/ai-code" target="_blank" :class="$style.help">
					<mage-icon icon="question-circle" color="text-light" size="large" />{{
		...
		<div :class="$style.controls">
			<div v-if="isLoading" :class="$style.loader">
				...
				<mage-circle-loader :radius="8" :progress="loaderProgress" :stroke-width="3" />
			</div>
			<mageTooltip v-else :disabled="isSubmitEnabled">
				<div>
					<mageButton
