...
import type { IRunData, Workflow } from 'mage-workflow';
import { jsonParse, NodeHelpers, NodeConnectionType } from 'mage-workflow';
	...
	>
		...
		>
			...
			<div :class="$style.backToCanvas" data-test-id="back-to-canvas" @click="close">
				<mage-icon icon="arrow-left" color="text-xlight" size="medium" />
				<mage-text color="text-xlight" size="medium" :bold="true">
