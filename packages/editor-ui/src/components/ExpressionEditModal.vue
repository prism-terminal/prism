...
import { mageInput, mageText } from 'mage-design-system';
import { mageResizeWrapper, type ResizeData } from 'mage-design-system';
		...
		<div :class="$style.container">
			...
			>
				<div :class="$style.sidebar">
					...
					>
						<template #prefix>
							<mageIcon :class="$style.ioSearchIcon" icon="search" />
						</template>
					</mageInput>
			...
			<div :class="$style.io">
				<div :class="$style.input">
					<div :class="$style.header">
						<mageText bold size="large">
							{{ i18n.baseText('expressionEdit.expression') }}
						</mageText>
						<mageText
							:class="$style.tip"
							size="small"
							v-mage-html="i18n.baseText('expressionTip.javascript')"
						/>
					</div>
