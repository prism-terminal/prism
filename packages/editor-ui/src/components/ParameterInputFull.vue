...
import type { INodeProperties, IParameterLabel, NodeParameterValueType } from 'mage-workflow';
import { mageInputLabel } from 'mage-design-system';
...
watch(
	() => props.isReadOnly,
	(isReadOnly) => {
		// Patch fix, see https://linear.app/mage/issue/ADO-2974/resource-mapper-values-are-emptied-when-refreshing-the-columns
