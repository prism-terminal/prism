...
import type { INodeTypeDescription, WorkflowParameters } from 'mage-workflow';
import { NodeConnectionType, Workflow } from 'mage-workflow';

const nodeType: INodeTypeDescription = {
	displayName: 'OpenAI',
	name: '@mage/mage-nodes-langchain.openAi',
	version: [1],
	inputs: [
...
const node: INodeUi = {
	...
	name: 'OpenAI',
	type: '@mage/mage-nodes-langchain.openAi',
	typeVersion: 1.6,
	position: [1300, 540],
};
        ...
        <div>
          <div class="connectedNodesWrapper" style="--nodes-length: 0;">
            <div class="plusButton">
              <mage-tooltip placement="top" teleported="true" offset="10" show-after="300" disabled="false">
                <mage-icon-button size="medium" icon="plus" type="tertiary" data-test-id="add-subnode-ai_tool"></mage-icon-button>
              </mage-tooltip>
            </div>
            <!--v-if-->
          </div>
