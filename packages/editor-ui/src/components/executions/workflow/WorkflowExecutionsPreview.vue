...
<template>
	<div v-if="executionUIDetails?.name === 'new'" :class="$style.newInfo">
		<mageText :class="$style.newMessage" color="text-light">
			{{ locale.baseText('executionDetails.newMessage') }}
		</mageText>
		<mageButton class="mt-l" type="tertiary" @click="handleStopClick">
			{{ locale.baseText('executionsList.stopExecution') }}
		</mageButton>
	</div>
	<div v-else-if="executionUIDetails?.name === 'running'" :class="$style.runningInfo">
		<div :class="$style.spinner">
			<mageSpinner type="ring" />
		</div>
		<mageText :class="$style.runningMessage" color="text-light">
	...
	<div v-else-if="executionUIDetails" :class="$style.previewContainer">
		...
		>
			...
			<div>
				<mageText size="large" color="text-base" :bold="true" data-test-id="execution-time">{{
				...
				{{ ' ' }}
				<mageText v-if="executionUIDetails?.showTimestamp === false" color="text-base" size="medium">
					| ID#{{ execution.id }}
				</mageText>
				<mageText v-else-if="executionUIDetails.name === 'running'" color="text-base" size="medium">
					{{
				...
				<br /><mageText v-if="execution.mode === 'retry'" color="text-base" size="medium">
