...
<template>
	...
	>
		<div :class="$style.heading">
			<mage-heading tag="h2" size="medium" color="text-dark">
		...
		>
			...
			>
				<mage-text color="text-base" size="medium" align="center">
