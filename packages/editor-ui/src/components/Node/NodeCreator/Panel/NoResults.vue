	...
	>
		...
		<div :class="$style.title">
			...
			>
				...
				<mage-link v-if="rootView === REGULAR_NODE_CREATOR_VIEW" @click="$emit('addHttpNode')">
					{{ i18n.baseText('nodeCreator.noResults.httpRequest') }}
				</mage-link>

				<mage-link v-if="rootView === TRIGGER_NODE_CREATOR_VIEW" @click="$emit('addWebhookNode')">
		...
		<div v-if="showRequest" :class="$style.request">
			...
			<div>
				<mage-link :to="REQUEST_NODE_FORM_URL">
