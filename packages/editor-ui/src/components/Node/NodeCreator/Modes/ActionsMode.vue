		...
		<OrderSwitcher v-if="rootView" :root-view="rootView">
				...
				>
					...
					<template v-else #empty>
						<p
							...
							@click="resetSearch"
							v-mage-html="i18n.baseText('nodeCreator.actionsCategory.noMatchingTriggers')"
						/>
					</template>
				</CategorizedItemsRenderer>
			</template>
			<template v-if="!isTriggerRootView || parsedActionActionsBaseline.length !== 0" #actions>
				...
				>
					...
					>
						<span v-mage-html="i18n.baseText('nodeCreator.actionsCallout.triggersStartWorkflow')" />
					</mage-callout>
					<!-- Empty state -->
					<template #empty>
						<mage-info-tip v-if="!search" theme="info" type="note" :class="$style.actionsEmpty">
							<span
								v-mage-html="
						...
						<p
							...
							@click="resetSearch"
							v-mage-html="i18n.baseText('nodeCreator.actionsCategory.noMatchingActions')"
						/>
					</template>
				</CategorizedItemsRenderer>
			</template>
