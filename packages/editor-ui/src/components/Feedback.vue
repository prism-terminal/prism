...
<template>
	<div class="feedback">
		<mageText v-if="!modelValue" class="mr-2xs">
			{{ i18n.baseText('feedback.title') }}
		</mageText>
		<mageText v-else :color="modelValue === 'positive' ? 'success' : 'danger'">
			<FontAwesomeIcon
		...
		<mageTooltip v-if="!modelValue" :content="i18n.baseText('feedback.positive')">
			<span
		...
		<mageTooltip v-if="!modelValue" :content="i18n.baseText('feedback.negative')">
			<span
				class="feedback-button"
