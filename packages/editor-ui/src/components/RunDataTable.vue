...
import type { GenericValue, IDataObject, INodeExecutionData } from 'mage-workflow';
...
import { mageIconButton, mageInfoTip, mageTooltip, mageTree } from 'mage-design-system';
			...
			<tbody>
				...
				>
					...
					<td
						...
						@mouseleave="onMouseLeaveCell"
					>
						<mageInfoTip>{{ i18n.baseText('runData.emptyItemHint') }}</mageInfoTip>
					</td>
			...
			<thead>
				<tr>
					...
					<th v-for="(column, i) in tableData.columns || []" :key="column">
						<mageTooltip placement="bottom-start" :disabled="!mappingEnabled" :show-after="1000">
							<template #content>
								<div>
					...
					<th v-if="columnLimitExceeded" :class="$style.header">
						<mageTooltip placement="bottom-end">
							<template #content>
								<div>
			...
			>
				...
				>
					...
					>
						...
						/>
						<mageTree v-else-if="isObject(data)" :node-class="$style.nodeClass" :value="data">
