	...
	>
		<template #header>
			<div :class="$style.title">
				<mage-heading tag="h2" size="medium" color="text-xlight">{{ modalTitle }}</mage-heading>
			</div>
		</template>
		<template #content>
			<section :class="$style.content">
				<div v-if="showButtons" :class="$style.wrapper">
					...
					<div :class="$style.text">
						<mage-text size="small" color="text-xlight">{{ NOT_LIKELY_OPTION }}</mage-text>
						<mage-text size="small" color="text-xlight">{{ VERY_LIKELY_OPTION }}</mage-text>
					</div>
				</div>
				<div v-else :class="$style.email">
					...
					<div :class="$style.disclaimer">
						<mage-text size="small" color="text-dark">
