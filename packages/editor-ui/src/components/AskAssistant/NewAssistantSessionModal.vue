...
import AssistantIcon from 'mage-design-system/components/AskAssistantIcon/AssistantIcon.vue';
import AssistantText from 'mage-design-system/components/AskAssistantText/AssistantText.vue';
	...
	>
		...
		<template #content>
			<div :class="$style.container">
				<p>
					<mage-text>{{ i18n.baseText('aiAssistant.newSessionModal.message') }}</mage-text>
				</p>
				<p>
					<mage-text>{{ i18n.baseText('aiAssistant.newSessionModal.question') }}</mage-text>
				</p>
			</div>
		</template>
		<template #footer>
			<div :class="$style.footer">
				<mage-button :label="i18n.baseText('generic.cancel')" type="secondary" @click="close" />
				<mage-button
