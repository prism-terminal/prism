...
<template>
	<span :class="$style.container" data-test-id="node-title-container" @click="onEdit">
		...
		<mage-popover placement="right" width="200" :visible="editName" :disabled="!editable">
			<div
			...
			>
				<mage-text :bold="true" color="text-base" tag="div">{{
					i18n.baseText('ndv.title.renameNode')
				}}</mage-text>
				<mage-input ref="input" v-model="newName" size="small" data-test-id="node-rename-input" />
