...
const alias = [
	...
	{
		find: /^@mage\/chat$/,
		replacement: resolve(__dirname, '..', '@mage', 'chat', 'src', 'index.ts'),
	},
	{
		find: /^@mage\/chat\//,
		replacement: resolve(__dirname, '..', '@mage', 'chat', 'src') + '/',
	},
...
export default mergeConfig(
	defineConfig({
		...
		css: {
			preprocessorOptions: {
				scss: {
					additionalData: '\n@use "@/mage-theme-variables.scss" as *;\n',
				},
			},
		},
		build: {
