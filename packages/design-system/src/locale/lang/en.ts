...
import type { mageLocale } from 'mage-design-system/types';
...
export default {
	...
	'sticky.markdownHint':
		'You can style with <a href="https://docs.mage.io/workflows/sticky-notes/" target="_blank">Markdown</a>',
	...
	'assistantChat.sessionEndMessage.2': 'button in mage',
	'assistantChat.you': 'You',
	'assistantChat.quickRepliesTitle': 'Quick reply 👇',
	'assistantChat.placeholder.1': () =>
		'I can answer most questions about building workflows in mage.',
