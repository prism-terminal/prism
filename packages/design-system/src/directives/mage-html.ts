...
/**
 * Custom directive `mageHtml` to replace v-html from Vue to sanitize content.
 *
 * Usage:
 * In your Vue template, use the directive `v-mage-html` passing the unsafe HTML.
 *
 * Example:
 * <p v-mage-html="'<a href="https://site.com" onclick="alert(1)">link</a>'">
 *
...
export const mageHtml: ObjectDirective = {
