...
import mageActionToggle from '../mageActionToggle';
import mageBadge from '../mageBadge';
import mageUserInfo from '../mageUserInfo';
	...
	<div>
		...
		>
			...
			<div :class="$style.badgeContainer">
				<mageBadge v-if="user.isOwner" theme="tertiary" bold>
