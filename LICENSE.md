...
- Source code files that contain ".ee." in their filename or ".ee" in their dirname are NOT licensed under
  ...
  To use source code files that contain ".ee." in their filename or ".ee" in their dirname you must hold a
	valid mage Enterprise License specifically allowing you access to such source code files and as defined
	in "LICENSE_EE.md".
- All third party components incorporated into the mage Software are licensed under the original license
